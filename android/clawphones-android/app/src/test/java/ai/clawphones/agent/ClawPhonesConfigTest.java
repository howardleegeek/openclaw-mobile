...
/**
 * Unit tests for ClawPhonesConfig
 *
 * Note: ClawPhonesConfig uses hardcoded paths from TermuxConstants which point to
...
@Config(sdk = 28)
public class ClawPhonesConfigTest {
     ...
     * because ClawPhonesConfig.readConfig() uses hardcoded Termux paths.
    ...
    public void testSetProvider_createsCorrectStructure() {
        ...
        boolean result = ClawPhonesConfig.setProvider("anthropic", "claude-sonnet-4-5");
    ...
    public void testSetProvider_withNullValues_handlesGracefully() {
        ...
        try {
            boolean result = ClawPhonesConfig.setProvider(null, null);
    ...
    public void testSetApiKey_withNonExistentPaths_handlesGracefully() {
        ...
        boolean result = ClawPhonesConfig.setApiKey("anthropic", "test-key-123");
    ...
    public void testIsConfigured_noConfig_returnsFalse() {
        boolean configured = ClawPhonesConfig.isConfigured();
    ...
    public void testExpectedConfigStructure() throws JSONException {
        ...
        defaults.put("workspace", "~/clawphones");
        ...
        auth.put("token", "clawphones-local-token");
