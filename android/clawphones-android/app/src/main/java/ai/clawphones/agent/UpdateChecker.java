...
/**
 * Lightweight version checker that queries the ClawPhones API for the latest release.
...
public class UpdateChecker {
    ...
    private static final String CHECK_URL = "https://api.clawphones.com/version";
    private static final long CHECK_INTERVAL_MS = 24 * 60 * 60 * 1000; // 24 hours
    private static final int CONNECT_TIMEOUT_MS = 10000;
    private static final int READ_TIMEOUT_MS = 10000;
    private static final String PREFS_NAME = "clawphones_update";
